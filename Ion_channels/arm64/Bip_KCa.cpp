...
#define nrn_init _nrn_init__Bip_KCa
#define _nrn_initial _nrn_initial__Bip_KCa
#define nrn_cur _nrn_cur__Bip_KCa
#define _nrn_current _nrn_current__Bip_KCa
#define nrn_jacob _nrn_jacob__Bip_KCa
#define nrn_state _nrn_state__Bip_KCa
#define _net_receive _net_receive__Bip_KCa 
#define rates rates__Bip_KCa 
#define states states__Bip_KCa 
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_Bip_KCa", _hoc_setdata},
 {"rates_Bip_KCa", _hoc_rates},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Bip_KCa /Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/Bip_KCa.mod\n");
...
static int  rates ( _internalthreadargsprotocomma_ double _lv ) {
   double _la , _lb , _lam , _lbm , _lvred ;
 _lvred = _lv - vshift ;
   _lam = ( 100.0 * ( 230.0 - _lvred ) ) / ( ( exp ( ( 230.0 - _lvred ) / 52.0 ) ) - 1.0 ) ;
   _lbm = 120.0 * ( exp ( ( - _lvred / 95.0 ) ) ) ;
   tau_m = 1.0 / ( _lam + _lbm ) ;
   m_inf = _lam * tau_m ;
    return 0; }
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_Bip_KCa. Requires prior call to setdata_Bip_KCa and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/Bip_KCa.mod";
