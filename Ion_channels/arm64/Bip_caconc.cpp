...
#define t _nt->_t
#define dt _nt->_dt
#define taur _ml->template fpfield<0>(_iml)
#define taur_columnindex 0
#define area_um2 _ml->template fpfield<1>(_iml)
#define area_um2_columnindex 1
#define vol_um3 _ml->template fpfield<2>(_iml)
#define vol_um3_columnindex 2
...
#define areal _ml->template fpfield<5>(_iml)
#define areal_columnindex 5
#define voll _ml->template fpfield<6>(_iml)
#define voll_columnindex 6
#define cai _ml->template fpfield<7>(_iml)
#define cai_columnindex 7
#define Dcai _ml->template fpfield<8>(_iml)
...
static NPyDirectMechFunc npy_direct_func_proc[] = {
 ...
 #define gind 0
 #define _gth 0
#define ca_res ca_res_Bip_caconc
 double ca_res = 0.15;
#define shell_thickness shell_thickness_Bip_caconc
 ...
 {"ca_res_Bip_caconc", "uM"},
 {"shell_thickness_Bip_caconc", "um"},
 {"taur_Bip_caconc", "ms"},
 {"area_um2_Bip_caconc", "um2"},
 {"vol_um3_Bip_caconc", "um3"},
 {0, 0}
};
 ...
 {"ca_res_Bip_caconc", &ca_res_Bip_caconc},
 {"shell_thickness_Bip_caconc", &shell_thickness_Bip_caconc},
 {0, 0}
};
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 6, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 11);
 	...
 	taur = _parm_default[0]; /* 1.5 */
 	area_um2 = _parm_default[1]; /* 0 */
 	vol_um3 = _parm_default[2]; /* 0 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 11);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"taur"} /* 0 */,
                                       _nrn_mechanism_field<double>{"area_um2"} /* 1 */,
                                       _nrn_mechanism_field<double>{"vol_um3"} /* 2 */,
                                       _nrn_mechanism_field<double>{"ica"} /* 3 */,
                                       _nrn_mechanism_field<double>{"eca"} /* 4 */,
                                       _nrn_mechanism_field<double>{"areal"} /* 5 */,
                                       _nrn_mechanism_field<double>{"voll"} /* 6 */,
                                       _nrn_mechanism_field<double>{"cai"} /* 7 */,
                                       _nrn_mechanism_field<double>{"Dcai"} /* 8 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Bip_caconc /Users/lillikiessling/Documents/Stanford/BC_model_new/Ion_channels/Bip_caconc.mod\n");
...
static int _reset;
static const char *modelname = "Bipolar Cell Calcium Concentration Mechanism (ON-type)";
...
/*CVODE*/
 static int _ode_spec1 (_internalthreadargsproto_) {int _reset = 0; {
   Dcai = - ( 1e-8 * ica * areal ) / ( 2.0 * FARADAY * voll ) * 1e6 + ( ca_res - cai ) / taur ;
   }
 return _reset;
}
 static int _ode_matsol1 (_internalthreadargsproto_) {
 ...
 /*END CVODE*/
 static int state (_internalthreadargsproto_) { {
    cai = cai + (1. - exp(dt*(( ( ( - 1.0 ) ) ) / taur)))*(- ( ( ( - ( ( ( 1e-8 )*( ica ) )*( areal ) ) ) / ( 2.0 * FARADAY * voll ) )*( 1e6 ) + ( ( ca_res ) ) / taur ) / ( ( ( ( - 1.0 ) ) ) / taur ) - cai) ;
   }
  return 0;
}
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/lillikiessling/Documents/Stanford/BC_model_new/Ion_channels/Bip_caconc.mod";
