...
#define nrn_init _nrn_init__modulator
#define _nrn_initial _nrn_initial__modulator
#define nrn_cur _nrn_cur__modulator
#define _nrn_current _nrn_current__modulator
#define nrn_jacob _nrn_jacob__modulator
#define nrn_state _nrn_state__modulator
#define _net_receive _net_receive__modulator 
...
#define alpha alpha_modulator
#define mramp mramp_modulator
 extern double alpha( double );
 extern double mramp( double );
 /* declare global and static user variables */
 #define gind 0
 #define _gth 0
#define e e_modulator
 double e = 0;
#define mod mod_modulator
 double mod = 0;
 ...
 {"e_modulator", &e_modulator},
 {"mod_modulator", &mod_modulator},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 modulator /Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/modulate.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/modulate.mod";
