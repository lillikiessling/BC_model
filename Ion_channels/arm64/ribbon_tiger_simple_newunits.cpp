...
#define nrn_init _nrn_init__ribbon_tiger_simple2
#define _nrn_initial _nrn_initial__ribbon_tiger_simple2
#define nrn_cur _nrn_cur__ribbon_tiger_simple2
#define _nrn_current _nrn_current__ribbon_tiger_simple2
#define nrn_jacob _nrn_jacob__ribbon_tiger_simple2
#define nrn_state _nrn_state__ribbon_tiger_simple2
#define _net_receive _net_receive__ribbon_tiger_simple2 
#define _f_rates _f_rates__ribbon_tiger_simple2 
#define kstates kstates__ribbon_tiger_simple2 
#define rates rates__ribbon_tiger_simple2 
...
#define transmitter transmitter_ribbon_tiger_simple2
 extern double transmitter( double );
 /* declare global and static user variables */
 #define gind 0
 #define _gth 0
#define total_count total_count_ribbon_tiger_simple2
 double total_count = 0;
#define usetable usetable_ribbon_tiger_simple2
 double usetable = 1;
#define vmax vmax_ribbon_tiger_simple2
 double vmax = 100;
#define vmin vmin_ribbon_tiger_simple2
 double vmin = -200;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 {"usetable_ribbon_tiger_simple2", 0, 1},
 {0, 0, 0}
};
 static HocParmUnits _hoc_parm_units[] = {
 {"vmin_ribbon_tiger_simple2", "mV"},
 {"vmax_ribbon_tiger_simple2", "mV"},
 {"erev", "mV"},
 {"erevN", "mV"},
 {"gmax", "umho"},
 {"gmaxN", "umho"},
 ...
 {"vmin_ribbon_tiger_simple2", &vmin_ribbon_tiger_simple2},
 {"vmax_ribbon_tiger_simple2", &vmax_ribbon_tiger_simple2},
 {"total_count_ribbon_tiger_simple2", &total_count_ribbon_tiger_simple2},
 {"usetable_ribbon_tiger_simple2", &usetable_ribbon_tiger_simple2},
 {0, 0}
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _ribbon_tiger_simple_newunits_reg() {
	int _vectorized = 0;
  _initlists();
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ribbon_tiger_simple2 /Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/ribbon_tiger_simple_newunits.mod\n");
 ...
 v=_v;
{
 ...
 if(error){
  std_cerr_stream << "at line 327 in file ribbon_tiger_simple_newunits.mod:\n\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/ribbon_tiger_simple_newunits.mod";
  ...
  "\n"
  "NEURON {\n"
  "     POINT_PROCESS ribbon_tiger_simple2\n"
