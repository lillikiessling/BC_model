...
#define nrn_init _nrn_init__FCM_Sikora
#define _nrn_initial _nrn_initial__FCM_Sikora
#define nrn_cur _nrn_cur__FCM_Sikora
#define _nrn_current _nrn_current__FCM_Sikora
#define nrn_jacob _nrn_jacob__FCM_Sikora
#define nrn_state _nrn_state__FCM_Sikora
#define _net_receive _net_receive__FCM_Sikora 
#define evaluate_fct evaluate_fct__FCM_Sikora 
#define states states__FCM_Sikora 
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_FCM_Sikora", _hoc_setdata},
 {"evaluate_fct_FCM_Sikora", _hoc_evaluate_fct},
 {"states_FCM_Sikora", _hoc_states},
 {0, 0}
};
...
#define cadis cadis_FCM_Sikora
 ...
 {"cadis_FCM_Sikora", "mM"},
 {"gnabar_FCM_Sikora", "mS/cm2"},
 {"gkbar_FCM_Sikora", "mS/cm2"},
 {"gabar_FCM_Sikora", "mS/cm2"},
 {"gcabar_FCM_Sikora", "mS/cm2"},
 {"gkcabar_FCM_Sikora", "mS/cm2"},
 {"idrk_FCM_Sikora", "mA/cm2"},
 {"iak_FCM_Sikora", "mA/cm2"},
 {"icak_FCM_Sikora", "mA/cm2"},
 {0, 0}
};
 static double c0 = 0;
 ...
 {"cadis_FCM_Sikora", &cadis_FCM_Sikora},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 10, "ca_ion");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 FCM_Sikora /Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/FCM_Sikora.mod\n");
...
static void _hoc_states(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for states_FCM_Sikora. Requires prior call to setdata_FCM_Sikora and that the specified mechanism instance still be in existence.", NULL);
  } else {
...
static void _hoc_evaluate_fct(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for evaluate_fct_FCM_Sikora. Requires prior call to setdata_FCM_Sikora and that the specified mechanism instance still be in existence.", NULL);
  } else {
    _setdata(_extcall_prop);
  }
   _r = 1.;
...
static int _ode_count(int _type){ hoc_execerror("FCM_Sikora", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
 ...
 { error =  states();
 if(error){
  std_cerr_stream << "at line 77 in file FCM_Sikora.mod:\n	SOLVE states\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/FCM_Sikora.mod";
