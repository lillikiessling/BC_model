...
#define nrn_init _nrn_init__Bip_HCN2
#define _nrn_initial _nrn_initial__Bip_HCN2
#define nrn_cur _nrn_cur__Bip_HCN2
#define _nrn_current _nrn_current__Bip_HCN2
#define nrn_jacob _nrn_jacob__Bip_HCN2
#define nrn_state _nrn_state__Bip_HCN2
#define _net_receive _net_receive__Bip_HCN2 
#define rates rates__Bip_HCN2 
#define states states__Bip_HCN2 
...
#define ghcn2_bar _ml->template fpfield<0>(_iml)
#define ghcn2_bar_columnindex 0
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_Bip_HCN2", _hoc_setdata},
 {"rates_Bip_HCN2", _hoc_rates},
 {0, 0}
};
...
static NPyDirectMechFunc npy_direct_func_proc[] = {
 ...
 #define gind 0
 #define _gth 0
#define m_inf m_inf_Bip_HCN2
 double m_inf = 0;
#define tau_m tau_m_Bip_HCN2
 double tau_m = 0;
 ...
 {"m_inf_Bip_HCN2", &m_inf_Bip_HCN2},
 {"tau_m_Bip_HCN2", &tau_m_Bip_HCN2},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"ghcn2_bar"} /* 0 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Bip_HCN2 /Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/Bip_HCN2.mod\n");
...
static int  rates (  double _lv ) {
   double _lvred ;
 _lvred = _lv - vshift ;
   m_inf = 1.0 / ( 1.0 + exp ( ( _lvred + 42.0 ) / 6.2 ) ) ;
   tau_m = 120.0 ;
    return 0; }
...
static void _hoc_rates(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_Bip_HCN2. Requires prior call to setdata_Bip_HCN2 and that the specified mechanism instance still be in existence.", NULL);
  } else {
 ...
 v=_v;
{
 ...
 { error =  states();
 if(error){
  std_cerr_stream << "at line 32 in file Bip_HCN2.mod:\nBREAKPOINT {\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/Bip_HCN2.mod";
