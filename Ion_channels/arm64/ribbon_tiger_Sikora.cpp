...
#define nrn_init _nrn_init__ribbon_tiger
#define _nrn_initial _nrn_initial__ribbon_tiger
#define nrn_cur _nrn_cur__ribbon_tiger
#define _nrn_current _nrn_current__ribbon_tiger
#define nrn_jacob _nrn_jacob__ribbon_tiger
#define nrn_state _nrn_state__ribbon_tiger
#define _net_receive _net_receive__ribbon_tiger 
#define _f_rates _f_rates__ribbon_tiger 
#define kstates kstates__ribbon_tiger 
#define rates rates__ribbon_tiger 
...
#define preCA1	*_ppvar[2].get<double*>()
#define _p_preCA1 _ppvar[2].literal_value<void*>()
#define preCA2	*_ppvar[3].get<double*>()
#define _p_preCA2 _ppvar[3].literal_value<void*>()
...
#define transmitter transmitter_ribbon_tiger
 extern double transmitter( double );
 /* declare global and static user variables */
 #define gind 0
 #define _gth 0
#define total_count total_count_ribbon_tiger
 double total_count = 0;
#define usetable usetable_ribbon_tiger
 double usetable = 1;
#define vmax vmax_ribbon_tiger
 double vmax = 100;
#define vmin vmin_ribbon_tiger
 double vmin = -200;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 {"usetable_ribbon_tiger", 0, 1},
 {0, 0, 0}
};
 static HocParmUnits _hoc_parm_units[] = {
 {"vmin_ribbon_tiger", "mV"},
 {"vmax_ribbon_tiger", "mV"},
 {"erev", "mV"},
 {"erevN", "mV"},
 {"gmax", "umho"},
 {"gmaxN", "umho"},
 ...
 {"vmin_ribbon_tiger", &vmin_ribbon_tiger},
 {"vmax_ribbon_tiger", &vmax_ribbon_tiger},
 {"total_count_ribbon_tiger", &total_count_ribbon_tiger},
 {"usetable_ribbon_tiger", &usetable_ribbon_tiger},
 {0, 0}
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _ribbon_tiger_Sikora_reg() {
	int _vectorized = 0;
  _initlists();
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double*>{"preCA1", "pointer"} /* 2 */,
                                       _nrn_mechanism_field<double*>{"preCA2", "pointer"} /* 3 */,
                                       _nrn_mechanism_field<int>{"_cvode_ieq", "cvodeieq"} /* 4 */);
  hoc_register_prop_size(_mechtype, 182, 5);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ribbon_tiger /Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/ribbon_tiger_Sikora.mod\n");
 ...
 v=_v;
{
 ...
 if(error){
  std_cerr_stream << "at line 329 in file ribbon_tiger_Sikora.mod:\n\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/ribbon_tiger_Sikora.mod";
    const char* nmodl_file_text = 
  ": NOTE: This is the original ribbon_tiger synapse from Sikora 2005 which uses Calcium at two debths\n"
  "\n"
  "\n"
  "COMMENT\n"
