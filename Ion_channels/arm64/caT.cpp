...
#define nrn_init _nrn_init__Bip_CaT
#define _nrn_initial _nrn_initial__Bip_CaT
#define nrn_cur _nrn_cur__Bip_CaT
#define _nrn_current _nrn_current__Bip_CaT
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Bip_CaT /Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/caT.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/caT.mod";
