...
#define nrn_init _nrn_init__Bip_Kv
#define _nrn_initial _nrn_initial__Bip_Kv
#define nrn_cur _nrn_cur__Bip_Kv
#define _nrn_current _nrn_current__Bip_Kv
#define nrn_jacob _nrn_jacob__Bip_Kv
#define nrn_state _nrn_state__Bip_Kv
#define _net_receive _net_receive__Bip_Kv 
#define rates rates__Bip_Kv 
#define states states__Bip_Kv 
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_Bip_Kv", _hoc_setdata},
 {"rates_Bip_Kv", _hoc_rates},
 {0, 0}
};
...
static NPyDirectMechFunc npy_direct_func_proc[] = {
 ...
 #define gind 0
 #define _gth 0
#define h_inf h_inf_Bip_Kv
 double h_inf = 0;
#define m_inf m_inf_Bip_Kv
 double m_inf = 0;
#define tau_h tau_h_Bip_Kv
 double tau_h = 0;
#define tau_m tau_m_Bip_Kv
 double tau_m = 0;
 ...
 {"m_inf_Bip_Kv", &m_inf_Bip_Kv},
 {"h_inf_Bip_Kv", &h_inf_Bip_Kv},
 {"tau_m_Bip_Kv", &tau_m_Bip_Kv},
 {"tau_h_Bip_Kv", &tau_h_Bip_Kv},
 {0, 0}
};
