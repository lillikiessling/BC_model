...
#define kd _ml->template fpfield<2>(_iml)
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 7, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 9);
 	...
 	cainf = _parm_default[1]; /* 0.0001 */
 	kd = _parm_default[2]; /* 0.0011 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 9);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"kd"} /* 2 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "diam");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 cas /Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/cas_Sikora.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (_internalthreadargsproto_) {int _reset = 0; {
   drive_channel = - ( ( 2.0 * ica ) / ( FARADAY * diam ) ) ;
   if ( drive_channel <= 0. ) {
     drive_channel = 0. ;
     }
   Dcai = drive_channel - ( ( cai - cainf ) / taur ) ;
   }
 return _reset;
}
 static int _ode_matsol1 (_internalthreadargsproto_) {
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/cas_Sikora.mod";
