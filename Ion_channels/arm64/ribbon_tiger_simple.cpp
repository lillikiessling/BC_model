...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _ribbon_tiger_simple_reg() {
	int _vectorized = 0;
  _initlists();
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ribbon_tiger_simple /Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/ribbon_tiger_simple.mod\n");
 ...
 v=_v;
{
 ...
 if(error){
  std_cerr_stream << "at line 327 in file ribbon_tiger_simple.mod:\n\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/ribbon_tiger_simple.mod";
