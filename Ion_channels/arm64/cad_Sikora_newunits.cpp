...
#define nrn_init _nrn_init__cad2
#define _nrn_initial _nrn_initial__cad2
#define nrn_cur _nrn_cur__cad2
#define _nrn_current _nrn_current__cad2
#define nrn_jacob _nrn_jacob__cad2
#define nrn_state _nrn_state__cad2
#define _net_receive _net_receive__cad2 
#define state state__cad2 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _cad_Sikora_newunits_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 cad2 /Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/cad_Sikora_newunits.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/cad_Sikora_newunits.mod";
