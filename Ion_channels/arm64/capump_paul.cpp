...
#define nrn_init _nrn_init__bip_cad
#define _nrn_initial _nrn_initial__bip_cad
#define nrn_cur _nrn_cur__bip_cad
#define _nrn_current _nrn_current__bip_cad
#define nrn_jacob _nrn_jacob__bip_cad
#define nrn_state _nrn_state__bip_cad
#define _net_receive _net_receive__bip_cad 
#define state state__bip_cad 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _capump_paul_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 bip_cad /Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/capump_paul.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/lillikiessling/Documents/Stanford/Code/BC_model/Ion_channels/capump_paul.mod";
