...
#define nrn_init _nrn_init__Bip_Na
#define _nrn_initial _nrn_initial__Bip_Na
#define nrn_cur _nrn_cur__Bip_Na
#define _nrn_current _nrn_current__Bip_Na
#define nrn_jacob _nrn_jacob__Bip_Na
#define nrn_state _nrn_state__Bip_Na
#define _net_receive _net_receive__Bip_Na 
#define rates rates__Bip_Na 
#define states states__Bip_Na 
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_Bip_Na", _hoc_setdata},
 {"rates_Bip_Na", _hoc_rates},
 {0, 0}
};
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_Bip_Na. Requires prior call to setdata_Bip_Na and that the specified mechanism instance still be in existence.", NULL);
  }
